...
namespace PHPNeus\BannerSlider\Model;

use PHPNeus\BannerSlider\Model\Banner\FileInfo;
...
class Banner extends \Magento\Framework\Model\AbstractModel
{
     ...
     * Banner cache tag
     */
    const CACHE_TAG = 'phpneus_banners_slider';
    ...
    {
        $this->_init('PHPNeus\BannerSlider\Model\ResourceModel\Banner');
    }
